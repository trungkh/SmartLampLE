...
import le.bluetooth.characteristics.BatteryLevel;
import le.bluetooth.characteristics.BodySensorLocation;
import le.bluetooth.characteristics.HeartRateMeasurement;
import le.bluetooth.smartgattlib.Characteristic;
import le.bluetooth.smartgattlib.Descriptor;
...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action,
        ...
        } else if (Characteristic.BODY_SENSOR_LOCATION.equals(characteristicUuid)) {
            BodySensorLocation bsl = new BodySensorLocation(data);
            intent.putExtra(EXTRA_DATA, "Body Sensor Location: " + bsl.getBodySensorLocation());
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
        ...
        // This is specific to HM-10 Transmit and Receive.
        else if (Characteristic.HM10_TRANSMISSION.equals(characteristic.getUuid())) {
            BluetoothGattDescriptor descriptor = characteristic.getDescriptor(Descriptor.CLIENT_CHARACTERISTIC_CONFIGURATION);
            descriptor.setValue(enabled ? BluetoothGattDescriptor.ENABLE_NOTIFICATION_VALUE : BluetoothGattDescriptor.DISABLE_NOTIFICATION_VALUE);
            mBluetoothGatt.writeDescriptor(descriptor);
        }
