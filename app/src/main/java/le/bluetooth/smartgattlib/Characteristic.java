...
public class Characteristic {
	...
	//For HM-10
	public static final UUID DEVICE_INFO_SERVICE = new UUID((0x1800L << 32) | 0x1000, GattUtils.leastSigBits);
	public static final UUID HM10_CONFIGURATION = new UUID((0xFFE0L << 32) | 0x1000, GattUtils.leastSigBits);
	public static final UUID HM10_TRANSMISSION = new UUID((0xFFE1L << 32) | 0x1000, GattUtils.leastSigBits);
	...
	static {
		...
		attributes.put(HM10_CONFIGURATION, "HM-10 Configuration");
		attributes.put(HM10_TRANSMISSION, "HM-10 Transmit and Receive");
    }
